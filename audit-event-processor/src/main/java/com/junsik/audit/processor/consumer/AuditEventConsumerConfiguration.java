...
@Slf4j
@ComponentScan(
		basePackages = {"com.junsik.audit.processor.consumer", "com.junsik.audit.processor.core"})
@Configuration
public class AuditEventConsumerConfiguration {
	...
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Object>>
			auditBatchConsumerContainerFactory() {
